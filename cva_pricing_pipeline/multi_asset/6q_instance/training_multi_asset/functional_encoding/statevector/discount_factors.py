...
def main() -> None:
    ...
    crca = CrcaCircuit(
        ...
        name="crca_discount_factors_crca2",
    )
    ...
    plot_training_diagnostics_multi_asset(
        ...
        title_before="Before training  (CRCA discount factors, COBYLA statevector)",
        title_after="After training  (best-iter, CRCA discount factors, COBYLA statevector)",
        cost_log_x=False,
        cost_log_y=True,
    )
    plt.show()
    ...
    metadata = {
        ...
        "seed_transpiler": SEED_TRANSPILER,
        "note": (
            "CRCA discount factors training via statevector-only COBYLA. "
