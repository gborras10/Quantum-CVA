...
def build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description=(
            ...
            "the 6q CVA Q^0 state-preparation circuit."
        )
    )
...
def _create_run_dir(raw: str | None) -> Path:
    if raw:
        ...
        run_dir = current_file.parent / "results" / f"qctrl_q0_smoke_{timestamp}"
