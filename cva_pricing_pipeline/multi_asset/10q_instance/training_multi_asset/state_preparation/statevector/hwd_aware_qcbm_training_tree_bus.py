...
def main():
    ...
    saving_path = (
        ...
        / "training" 
        / "qcbm" 
        / "best_10q_12lay_treebus"
        / "10q_sv_BEST_tree_bus_rzz.npz"
    )
    ...
    # ===================== PLots =====================
    plot_training_dynamics(cost_history, target_entropy, n_stage1)
